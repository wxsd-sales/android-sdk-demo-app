...
import com.example.webexandroid.firebase.RegisterTokenService
...
import com.example.webexandroid.calling.CallObserverInterface
...
class WebexViewModel(val webex: Webex, val repository: WebexRepository) : BaseViewModel() {
    ...
    fun dial(input: String, option: MediaOption) {
        try {
            ...
            Log.e("WebexApp Exception", "error: ${e.message}")
        }
    }
